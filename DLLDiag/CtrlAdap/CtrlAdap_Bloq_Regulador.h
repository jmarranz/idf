class CtrlAdap_Bloq_Regulador : public CBloqueFunc
{ 
public: 
	DECLARAR_BLOQUE_FUNCIONAL(CtrlAdap_Bloq_Regulador) 

	// Declaración de clases de comunicación de Entrada : 
	DECLARAR_COM_ENTRADA(CtrlAdap_Com_Ley_R) 
	virtual  BOOL RecibirDatosEntrada(CtrlAdap_Com_Ley_R* pE); 
